...
export function Pill({ t, icon, children }) {
  return (
    <View style={[styles.pill, { backgroundColor: t.sageTint }]}>
...
// Illustrated skylines — Florence has its dome; 'new' is a generic town for added trips.
...
// Tiny illustrated postcards for the Memories strip
...
const styles = StyleSheet.create({
  sec: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', marginTop: 22, marginBottom: 10, marginHorizontal: 2 },
  secTitle: { fontFamily: fonts.display, fontSize: 19 },
  secAction: { fontFamily: fonts.bodyHeavy, fontSize: 12.5 },
  pill: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 999, paddingVertical: 5.5, paddingHorizontal: 12 },
  pillText: { fontFamily: fonts.bodyBold, fontSize: 12 },
  chip: { flex: 1, borderRadius: radius.md, borderWidth: 1, borderStyle: 'dashed', paddingVertical: 12, paddingHorizontal: 8, alignItems: 'center' },
  chipNumRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  chipNum: { fontFamily: fonts.display, fontSize: 22 },
  chipLab: { fontFamily: fonts.accent, fontSize: 13, marginTop: 5 },
  addRow: { borderWidth: 2, borderStyle: 'dashed', borderRadius: 20, paddingVertical: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, marginBottom: 14 },
  addRowText: { fontFamily: fonts.accent, fontSize: 14.5 },
  mem: { width: 96, height: 122, borderRadius: 16, overflow: 'hidden', marginRight: 10 },
  memCap: { fontFamily: fonts.accent, fontSize: 13, textAlign: 'center', paddingTop: 8 },
  memAdd: { borderWidth: 2, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', gap: 6, shadowOpacity: 0, elevation: 0 },
  memAddText: { fontFamily: fonts.accent, fontSize: 12.5 },
});
