...
import { fonts, capsStyle } from '../theme';
    ...
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: t.bg }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <View style={styles.brand}>
          <AtlasMark size={80} ink={t.ink} gold={t.gold} />
        ...
        <Text style={[styles.label, { color: t.sage }]}>Email · optional</Text>
        <TextInput
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.display, fontSize: 34, letterSpacing: -0.5, marginTop: 12 },
  tagline: { ...capsStyle, fontSize: 10, letterSpacing: 3, marginTop: 6 },
  welcome: { fontFamily: fonts.displaySemi, fontSize: 19, letterSpacing: -0.2, marginBottom: 2 },
  label: { ...capsStyle, marginTop: 17, marginBottom: 7 },
  ...
  note: { fontFamily: fonts.bodySemi, fontSize: 12, textAlign: 'center', marginTop: 16, lineHeight: 18 },
});
